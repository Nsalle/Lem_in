...
/*   Updated: 2019/12/12 15:46:15 by nsalle      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
typedef struct				s_list_soluce
{
	...
	unsigned int			parent;
	int						id;
	struct s_list_soluce	*next;
}							t_list_soluce;

typedef struct				t_list_answ
{
	char					*line;
...
typedef struct				s_lem
{
	...
	// J'ai besoin que tu remplisse avec l'algo pour le visu
	int						nb_turn;
...
//void	free_list(t_list_soluce *list);
